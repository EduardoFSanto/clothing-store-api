...
export async function getProductVariantsController(
  ...
  const variants =
    await productVariantsService.findByProductId(
      productId,
    );
...
export async function getProductVariantByIdController(
  ...
  const variant =
    await productVariantsService.findById(id);
...
export async function createProductVariantController(
  ...
  const input =
    createProductVariantSchema.parse(req.body);
...
export async function updateProductVariantController(
  ...
  const input =
    updateProductVariantSchema.parse(req.body);

  const variant =
    await productVariantsService.update(
      id,
      input,
    );
